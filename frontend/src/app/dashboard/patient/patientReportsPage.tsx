        ...
        <div className="space-y-8 pb-12 animate-in fade-in duration-500">
            ...
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-[#2C3E3E] tracking-tight">Medical Reports</h1>
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                    <div className="flex flex-col items-center bg-white border border-[#E2E8F0] rounded-2xl px-5 py-3 shadow-sm">
                        <span className="text-2xl font-black text-[#2C3E3E]">{totalReports}</span>
            ...
            <div className="bg-white p-4 rounded-3xl shadow-sm border border-[#E2E8F0] flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full pl-11 pr-4 py-3 bg-[#F6F7F5] rounded-2xl border-transparent focus:bg-white focus:border-[#8FB9A8] border outline-none transition-all font-medium text-sm text-[#2C3E3E]"
                    />
                </div>
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-[2rem] border border-dashed border-[#E2E8F0] py-24 flex flex-col items-center gap-4">
                    ...
                    <div className="text-center">
                        <h3 className="text-lg font-black text-[#2C3E3E]">
