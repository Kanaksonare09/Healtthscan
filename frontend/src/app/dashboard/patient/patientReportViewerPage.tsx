            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <div className="flex items-center space-x-3 mb-2">
                        ...
                        <h1 className="text-2xl font-black text-[#2C3E3E] tracking-tight">{mockReport.reportName}</h1>
                    </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="bg-[#4F6F6F] text-white px-6 py-2.5 rounded-xl font-black text-xs uppercase tracking-widest shadow-md hover:bg-[#2C3E3E] transition-all">Download PDF</button>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 flex-1 min-h-[600px]">
                ...
                <div className="lg:col-span-5 space-y-6">
                    <div className="bg-white p-8 rounded-[40px] shadow-sm border border-[#E2E8F0]">
                        <h3 className="text-xl font-black text-[#2C3E3E] mb-6 flex items-center space-x-2">
