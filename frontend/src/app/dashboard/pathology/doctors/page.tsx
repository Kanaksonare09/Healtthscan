    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-black text-[#2C3E3E]">Doctor Directory</h1>
            ...
            {/* Modal */}
            {isModalOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#2C3E3E]/60 backdrop-blur-sm animate-in fade-in duration-300">
                    <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-md overflow-hidden animate-in zoom-in-95 duration-300">
                        <div className="p-8">
                            <div className="flex justify-between items-center mb-6">
                                <h2 className="text-2xl font-black text-[#2C3E3E]">Register Doctor</h2>
                                <button onClick={() => setIsModalOpen(false)} className="text-[#6B7280] hover:text-[#2C3E3E] transition-colors">
                        ...
                        <tbody className="divide-y divide-[#E2E8F0]">
                            {loading ? (
                                ...
                                <tr key={doc._id} className="hover:bg-[#F6F7F5] transition-colors group">
                                    <td className="px-8 py-5 text-sm font-bold text-[#2C3E3E]">{doc.name}</td>
