    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-black text-[#2C3E3E]">Patient Directory</h1>
                            ...
                            {loading ? (
                                ...
                                <tr key={patient._id} className="hover:bg-[#F6F7F5] transition-colors">
                                    <td className="px-8 py-5">
                                        <div className="text-sm font-bold text-[#2C3E3E]">{patient.name}</div>
                                    ...
                                    <td className="px-8 py-5 text-right">
                                        <Link
                                            ...
                                            className="bg-[#4F6F6F] text-white px-4 py-2 rounded-xl text-xs font-black hover:bg-[#2C3E3E] transition-all active:scale-95 shadow-sm inline-flex items-center gap-1.5"
                                        >
                            ...
                            {!loading && patients.length === 0 && (
                                <tr>
                                    <td colSpan={4} className="px-8 py-16 text-center">
                                        ...
                                        <p className="text-[#2C3E3E] font-bold">
