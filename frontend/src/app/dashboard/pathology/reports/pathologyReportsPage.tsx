...
export default function ReportsPage() {
    ...
    const exportReports = () => {
        ...
        link.setAttribute("download", `healthscan_reports_${new Date().toISOString().split('T')[0]}.csv`);
    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-700">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-black text-[#2C3E3E]">Digital Report Archive</h1>
                ...
                <div className="p-6 border-b border-[#E2E8F0] bg-[#F6F7F5]/50">
                    <div className="flex flex-col md:flex-row gap-4">
                        ...
                        <select
                            ...
                            className="bg-white px-6 py-3 rounded-2xl border border-[#E2E8F0] outline-none font-bold text-[#2C3E3E] min-w-[200px]"
                        >
                        ...
                        <tbody className="divide-y divide-[#E2E8F0]">
                            {loading ? (
                                ...
                                <tr key={report._id} className="hover:bg-[#F6F7F5] transition-colors group">
                                    <td className="px-8 py-5 text-sm font-bold text-[#2C3E3E]">{report.reportName}</td>
                                    ...
                                    <td className="px-8 py-5 text-right">
                                        <a
                                            ...
                                            target="_blank"
                                            className="bg-[#F6F7F5] text-[#2C3E3E] font-black px-5 py-2 rounded-xl text-xs hover:bg-[#4F6F6F] hover:text-white border border-[#E2E8F0] shadow-sm transition-all inline-block"
                                        >
                                            View Report
                                        </a>
                                    </td>
