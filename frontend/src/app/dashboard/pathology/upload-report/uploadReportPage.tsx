...
function UploadForm() {
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div>
                <h1 className="text-3xl font-black text-[#2C3E3E]">Upload Lab Report</h1>
                    ...
                    <form onSubmit={handleUpload} className="max-w-2xl mx-auto space-y-8">
                                        ...
                                        {patients.map((p) => (
                                            ...
                                            >
                                                <div className="flex justify-between items-center">
                                                    <div>
                                                        <p className="text-sm font-bold text-[#2C3E3E]">{p.name}</p>
                        ...
                        >
                            ...
                            {file ? (
                                ...
                                <>
                                    <h3 className="text-xl font-bold text-[#2C3E3E]">Drop lab report PDF or Image here</h3>
                        ...
                        <button
                            ...
                            className={`w-full group btn-primary h-16 text-xl shadow-lg transition-all transform ${(!file || !selectedPatient) 
                                ...
                                : 'bg-[#4F6F6F] hover:bg-[#2C3E3E] hover:scale-[1.02] active:scale-[0.98]'}`}
                        >
                            {uploading ? (
