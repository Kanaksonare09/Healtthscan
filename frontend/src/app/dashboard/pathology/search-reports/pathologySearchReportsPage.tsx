...
export default function SearchReportsPage() {
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-extrabold text-[#2C3E3E]">Search Reports</h1>
                ...
                <div className="max-w-3xl mx-auto space-y-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="p-8 rounded-3xl border border-dashed border-[#E2E8F0] bg-slate-50 flex flex-col items-center text-center">
                            ...
                            <h4 className="font-bold text-[#2C3E3E]">Scan Report QR</h4>
                        ...
                        <div className="p-8 rounded-3xl border border-dashed border-[#E2E8F0] bg-slate-50 flex flex-col items-center text-center">
                            ...
                            <h4 className="font-bold text-[#2C3E3E]">Advanced Filters</h4>
