    ...
    return (
      <div className="flex items-center gap-3">
        <button
          onClick={togglePlay}
          disabled={isLoading}
          className="w-10 h-10 bg-[#4F6F6F] text-white rounded-full flex items-center justify-center hover:bg-[#2C3E3E] transition-all shadow-md active:scale-95 disabled:opacity-50"
        >
          {isLoading ? (
    ...
    <div className="bg-white border border-[#E2E8F0] rounded-[32px] p-6 shadow-sm">
      <div className="flex items-center gap-3 mb-5">
        ...
        <div className="flex-1">
          ...
          {reportName && <p className="text-sm font-bold text-[#2C3E3E] truncate">{reportName}</p>}
        </div>
      </div>
      ...
      <div className="flex items-center justify-center gap-4">
        <button
          onClick={togglePlay}
          disabled={isLoading}
          className="w-14 h-14 bg-[#4F6F6F] text-white rounded-full flex items-center justify-center hover:bg-[#2C3E3E] transition-all shadow-lg active:scale-95 disabled:opacity-60"
        >
          {isLoading ? (
