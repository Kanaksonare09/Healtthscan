      ...
      <div className="bg-white rounded-[2rem] shadow-2xl w-full max-w-lg relative animate-in zoom-in-95 duration-300">
        ...
        <div className="p-8 border-b border-[#E2E8F0] flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl font-black text-[#2C3E3E]">Upload Report</h2>
              <p className="text-xs text-[#6B7280] font-medium">Add your lab results to HealthScan</p>
            </div>
          </div>
          <button onClick={onClose} className="p-2 text-[#6B7280] hover:text-[#2C3E3E] hover:bg-[#F6F7F5] rounded-xl transition-all">
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-5">
          ...
          >
            ...
            {file ? (
              <div className="space-y-1">
                ...
                <p className="font-black text-[#2C3E3E]">{file.name}</p>
              ...
              <div className="space-y-2">
                ...
                <p className="font-black text-[#2C3E3E]">Drop PDF or Image here</p>
          ...
          {uploading && (
            <div className="space-y-2">
              <div className="flex justify-between text-sm font-bold text-[#2C3E3E]">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              ...
              className="flex-1 py-3 rounded-2xl bg-[#4F6F6F] text-white font-black text-sm hover:bg-[#2C3E3E] transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {uploading ? (
