                    ...
                    <div className="flex items-start space-x-5">
                        ...
                        <div className="flex-1">
                            <div className="flex items-center space-x-3 mb-2">
                                <h3 className="text-2xl font-black text-[#2C3E3E] tracking-tight group-hover:text-[#4F6F6F] transition-colors">{report.reportName}</h3>
                                {report.aiSummary ? (
                ...
                <div className="flex flex-row lg:flex-col items-center lg:items-end justify-center lg:justify-start gap-4 lg:border-l lg:border-[#E2E8F0] lg:pl-8">
                    <div className="flex flex-col gap-2.5 w-full lg:w-52 mb-4 lg:mb-0">
                        ...
                        <Link
                            ...
                            className="flex items-center justify-center space-x-2 bg-[#4F6F6F] text-white px-6 py-3.5 rounded-[22px] font-black text-[10px] uppercase tracking-widest hover:bg-[#2C3E3E] shadow-md hover:shadow-xl transition-all active:scale-95 group/btn"
                        >
